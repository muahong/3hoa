/* ============================================================
   audio.js – Âm thanh cho Vệ Binh Cửu Chương
   - Sfx: hiệu ứng vũ trụ tổng hợp bằng Web Audio (không cần file mp3)
...
(function () {
  ...
  /* ---------------- Bản nhạc ---------------- */
  const TRACKS = {
    // Khi chơi: dồn dập, 132 BPM, 8 ô nhịp
    game: {
      bpm: 132,
      ...
      lead: expand([
        ...
        ['F5', 2], ['E5', 2], ['D5', 2], ['F5', 2], ['E5', 6], [null, 2],
        ['G5', 2], ['G5', 2], ['A5', 2], ['B5', 2], ['C6', 4], ['B5', 2], ['A5', 2],
        ['G5', 2], ['E5', 2], ['G5', 2], ['A5', 2], ['G5', 2], ['E5', 2], ['D5', 4],
        ['C5', 2], ['E5', 2], ['G5', 2], ['E5', 2], ['A5', 2], ['F5', 2], ['D5', 4],
        ['E5', 2], ['D5', 2], ['C5', 2], ['D5', 2], ['C5', 8]
      ]),
      bass: bassLine(['C3', 'G2', 'A2', 'F2', 'C3', 'G2', 'F2', 'C3'], true),
      bassVol: 0.13,
      kick: 'x...x...x...x...',
      snare: '....x.......x...',
      hat: 'x.x.x.x.x.x.x.x.'
    },
    // Menu: bồng bềnh ngoài vũ trụ, 88 BPM, rải hợp âm La thứ
    menu: {
      bpm: 88,
      ...
      bass: bassLine(['A2', 'F2', 'C3', 'G2'], false),
      bassVol: 0.09,
      kick: '', snare: '', hat: '......x.......x.'
    }
  };
  ...
  const Sfx = {
    ...
    play(name) {
      ...
      try {
        switch (name) {
          case 'key':                                   // gõ phím số
            this._tone(880 + Math.random() * 120, { type: 'sine', dur: 0.05, vol: 0.16, slide: 1200 });
            break;
          case 'del':
            this._tone(500, { type: 'sine', dur: 0.06, vol: 0.14, slide: 300 });
            break;
          case 'laser':                                 // pháo bắn
            this._tone(1500, { type: 'sawtooth', dur: 0.22, vol: 0.2, slide: 180 });
            this._tone(2200, { type: 'square', dur: 0.12, vol: 0.08, slide: 400 });
            break;
          case 'explode':                               // thiên thạch nổ
            this._noiseHit({ dur: 0.45, vol: 0.4, filter: 'lowpass', f0: 2200, f1: 120, q: 0.8 });
            this._tone(120, { type: 'sine', dur: 0.35, vol: 0.4, slide: 40 });
            break;
          case 'spawn':                                 // thiên thạch xuất hiện
          ...
          case 'wrong':
            ...
            break;
          case 'shieldhit':                             // thiên thạch đâm vào khiên
